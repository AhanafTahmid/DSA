...
//Using two pointer -> Time complexity: O(n^3 + nlogn) [nlogn for sorting] 
...
//Approach: Just move through left or through right, keep summing and check if s1==s2, if so keep the answer
